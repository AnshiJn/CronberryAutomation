...
public class Item extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2151695245833841065L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Item\",\"namespace\":\"CronberryTestng.CronberryTestng.service\",\"fields\":[{\"name\":\"name\",\"type\":\"string\"},{\"name\":\"sku\",\"type\":\"long\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static CronberryTestng.CronberryTestng.service.Item.Builder newBuilder() {
    return new CronberryTestng.CronberryTestng.service.Item.Builder();
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static CronberryTestng.CronberryTestng.service.Item.Builder newBuilder(CronberryTestng.CronberryTestng.service.Item.Builder other) {
    if (other == null) {
      return new CronberryTestng.CronberryTestng.service.Item.Builder();
    } else {
      return new CronberryTestng.CronberryTestng.service.Item.Builder(other);
    }
  }
   ...
   * @return A new Item RecordBuilder
   */
  public static CronberryTestng.CronberryTestng.service.Item.Builder newBuilder(CronberryTestng.CronberryTestng.service.Item other) {
    if (other == null) {
      return new CronberryTestng.CronberryTestng.service.Item.Builder();
    } else {
      return new CronberryTestng.CronberryTestng.service.Item.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Item>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(CronberryTestng.CronberryTestng.service.Item.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(CronberryTestng.CronberryTestng.service.Item other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public CronberryTestng.CronberryTestng.service.Item.Builder setName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CronberryTestng.CronberryTestng.service.Item.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public CronberryTestng.CronberryTestng.service.Item.Builder setSku(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CronberryTestng.CronberryTestng.service.Item.Builder clearSku() {
    ...
    /**
      ...
      * @return This builder.
      */
    public CronberryTestng.CronberryTestng.service.Item.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public CronberryTestng.CronberryTestng.service.Item.Builder clearQuantity() {
